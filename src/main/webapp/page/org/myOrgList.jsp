...
<script>
    layui.config({
        ...
        //加载页面数据
        var newsData = '';
        $.get(/*"/layui-admin/json/newsList.json",*/"/myOrgList", function(data){
            var newArray = [];
...
//                        }
                        ...
                        dataHtml +=  '<td><a class="layui-btn layui-btn-normal layui-btn-mini news_home" data-id="'+currData[i].id+'"><i class="layui-icon"></i> 首页</a>'
                            +  '<a class="layui-btn layui-btn-danger layui-btn-mini news_quit" data-id="'+currData[i].id+'"><i class="layui-icon">&#xe640;</i> 退出</a>'
                            +'</td>'
                            +'</tr>';
                    }
                }else{
